...
class _VipProfileScreenState extends State<VipProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int shippingCount =
        AppData.history.where((o) => o.status == 'Đang giao').length;
          ...
          children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (AppData.lifetimePoints >= 20000)
                            const Icon(
                              Icons.verified,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (AppData.lifetimePoints < 50000)
                          Text(
                            'Còn ${targetPoints - AppData.lifetimePoints} điểm để thăng hạng $nextTier.',
                            style: const TextStyle(
                              fontSize: 11,
                          ...
                          const Text(
                            'Bạn đã đạt cấp bậc cao nhất! Tận hưởng đặc quyền Kim Cương.',
                            style: TextStyle(
                              fontSize: 11,
                              color: Colors.black54,
                              fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: _buildWideStatCard(
                'Tổng chi tiêu',
                AppData.formatMoney(totalSpent),
                Icons.payments,
                Colors.orangeAccent,
              ),
            ),
  ...
  Widget _buildMilestoneDot(
    ...
    return Positioned(
      left: leftRatio == 1.0
          ? null
          : (maxWidth * leftRatio) - (leftRatio == 0.0 ? 0 : dotSize / 2),
      ...
      child: Tooltip(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isReached ? Colors.white : Colors.grey[400]!,
              width: 3,
            ),
            boxShadow: [
              if (isReached)
  ...
  void _showReviewInfoDialog() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Tổng số đánh giá đã gửi: ${AppData.reviews.length}\n'
