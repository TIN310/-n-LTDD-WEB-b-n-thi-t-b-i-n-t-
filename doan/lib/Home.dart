...
import 'dart:async'; // THÊM ĐỂ LÀM BANNER TỰ CHẠY
import 'product.dart';
import 'detail.dart';
import 'profile.dart';
...
// Thêm SingleTickerProviderStateMixin để làm hiệu ứng nhịp tim cho nút Chat
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  // Controller cho Banners & Animations
  ...
  void initState() {
    ...
    // 1. Cấu hình Banner tự động lướt
    ...
    // 2. Cấu hình nút Chat đập nhịp tim
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      extendBody: true, // GIÚP NỘI DUNG CUỘN LUỒN XUỐNG DƯỚI THANH NAV BAR
      appBar: AppBar(
        backgroundColor: Colors.black.withOpacity(0.9), // Trong suốt nhẹ
        elevation: 0,
      ...
      floatingActionButton: ScaleTransition(
        ...
        child: Container(
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.redAccent.withOpacity(0.5), blurRadius: 15, spreadRadius: 2) // Quầng sáng đỏ
              ]
          ),
      ...
      // THANH ĐIỀU HƯỚNG NỔI BO TRÒN (FLOATING)
      bottomNavigationBar: Container(
        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            backgroundColor: Colors.grey[900], // Xám đậm cho nổi bật trên nền đen
            type: BottomNavigationBarType.fixed,
            selectedItemColor: Colors.redAccent,
            unselectedItemColor: Colors.grey[500],
            showSelectedLabels: true,
            showUnselectedLabels: false, // Ẩn chữ khi không chọn cho gọn
  ...
  Widget _buildHomeTab() {
    return SingleChildScrollView(
      ...
      // Thêm padding bottom để nội dung không bị che bởi Floating NavBar
      ...
      child: Column(
        ...
        children: [
          ...
          // SẢN PHẨM ĐỀ XUẤT (KÈM HIỆU ỨNG TRƯỢT LÊN)
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // HIỆU ỨNG XUẤT HIỆN LẦN LƯỢT CHO SẢN PHẨM
              return TweenAnimationBuilder(
                tween: Tween<double>(begin: 0, end: 1),
                duration: Duration(milliseconds: 400 + (index * 100).clamp(0, 800)), // Delay tăng dần
                curve: Curves.easeOutQuart,
                builder: (context, double value, child) {
                  return Transform.translate(
                    offset: Offset(0, 50 * (1 - value)), // Trượt từ dưới lên
                    child: Opacity(opacity: value, child: child), // Mờ sang rõ
                  );
                },
                      ...
                      children: [
                        Expanded(
                          child: ClipRRect(
                            ...
                            child: Hero(
                              tag: 'product_img_${product.name}', // Hiệu ứng bay ảnh khi sang trang Detail
